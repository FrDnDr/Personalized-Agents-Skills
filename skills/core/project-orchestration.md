...
2. **[Domain Skills]** → `Implementation Phase`: Context-specific coding and architecture.
3. **code-review.md** → `Quality Phase`: Final audit against standards.
4. **git.md** → `Persistence Phase`: Conventional commit and push.
...
4. Gate the end of execution with `code-review.md` and `git.md`
...
STEP 5 — PROCEED:
Hand off to reasoning.md with the full loaded skill list.
```
